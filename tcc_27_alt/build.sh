...
CC=${CC:-cc}
CFLAGS=${CFLAGS:-"-Wall -g -O2 -fno-strict-aliasing -Wno-pointer-sign -Wno-sign-compare -Wno-unused-result"}
LDFLAGS=${LDFLAGS:-}
...
"$ROOTDIR/tcc" -B"$ROOTDIR" -Iinclude -I. -c lib/libtcc1.c -o "$ROOTDIR/libtcc1.o"
"$ROOTDIR/tcc" -B"$ROOTDIR" -Iinclude -I. -c lib/alloca86.S -o "$ROOTDIR/alloca86.o"
"$ROOTDIR/tcc" -ar rcs "$ROOTDIR/libtcc1.a" "$ROOTDIR/libtcc1.o" "$ROOTDIR/alloca86.o"
