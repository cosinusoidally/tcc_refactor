# tcc_27_layered_take3 Development Rules

## Scope

- This tree is the third layered refactor of `tcc_27`.
...
- Do not embed source files in `mk_tcc_27_layered_take3` with here-documents or
  generated strings. Put take3-specific fixtures in `tests/layered/` and have
