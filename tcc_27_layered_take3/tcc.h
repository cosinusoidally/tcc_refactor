...
# error unsupported target: tcc_27_layered_take3 requires i386 Linux
#endif
...
extern int tcc_add_dll(TCCState *s, const char *filename, int flags);
...
extern void vpush(CType *type);
extern void vpushsym(CType *type, Sym *sym);
extern void vpush_ref(CType *type, Section *sec, unsigned long offset, unsigned long size);
extern void vswap(void);
extern void vpush_global_sym(CType *type, int v);
...
extern void gv2(int rc1, int rc2);
extern void vpop(void);
extern void gen_op(int op);
extern void gen_opic(int operation);
...
extern void vla_runtime_pointed_size(CType *type);
...
extern void expr_shift(void);
extern void expr_cmp(void);
extern void expr_cmpeq(void);
